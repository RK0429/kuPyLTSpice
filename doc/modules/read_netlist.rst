...
kuPyLTSpice has the ability to read and manipulate netlist files using the :doc:`../classes/spice_editor` class.  
...
.. code-block::
    ...
    #read netlist
    import kuPyLTSpice
    net = kuPyLTSpice.SpiceEditor("Batch_Test.net")  # Loading the Netlist
...
.. code-block::
    ...
    #read netlist
    import kuPyLTSpice
    net = kuPyLTSpice.SpiceEditor("Example2.net")
...
* :py:class:`kuPyLTSpice.SpiceEditor`
* :py:class:`kuPyLTSpice.SpiceCircuit`
