...
It will return a :py:class:`kuPyLTSpice.raw_classes.Trace` object.  Use this object's ``get_wave()`` method to get
...
- :py:class:`kuPyLTSpice.raw_read.RawRead`
- :py:class:`kuPyLTSpice.raw_classes.Trace`
