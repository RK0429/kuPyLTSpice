...
"""This module reads data from an LTSpice RAW file. The main class object is the RawRead
...
* Operation Point                     * DC transfer characteristic                     *
AC Analysis                     * Transient Analysis                     * Noise
Spectral Density - (V/Hz½ or A/Hz½)                     * Transfer Function
...
* "FastAccess" -> Order of the data is changed to speed up access. See Binary section
for details.
...
this case this section is replaced with a "Values" section. LTSpice stores data directly
...
LTR.get_axis(step)  # Retrieves the time vector that will be used as X axis.
