...
class ASC_Editor_Test(unittest.TestCase):
    ...
    def test_component_editing(self):
        ...
        self.equalFiles(
            test_dir + "test_components_output.asc",
        ...
        self.equalFiles(
            test_dir + "test_components_output_1.asc",
    ...
    def test_parameter_edit(self):
        ...
        self.equalFiles(
            test_dir + "test_parameter_output.asc",
    ...
    def test_instructions(self):
        ...
        self.equalFiles(
            test_dir + "test_instructions_output.asc",
        ...
        self.equalFiles(
            test_dir + "test_instructions_output_1.asc",
